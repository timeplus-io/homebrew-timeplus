class ProtonAT1323 < Formula
    ...
    if Hardware::CPU.arm?
      ...
      sha256 "cc2601c0440c825c0ed126cf2f4c673be738d54a1249d97818465b2143541f20"
    else
      url "https://github.com/timeplus-io/proton/releases/download/v#{version}/proton-v#{version}-Darwin-x86_64"
      sha256 "bb0e65b371a0188a88731daa0acaaa604ba0eef1649967b599328ec21f91ed9f"
    end
    ...
    test do
      assert_match "jhao0117", shell_output("#{bin}/proton local --query 'SELECT * FROM system.contributors'")
    end
  end
