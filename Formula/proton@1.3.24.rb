class ProtonAT1324 < Formula
    ...
    if Hardware::CPU.arm?
      ...
      sha256 "5990b70cc34eb2715b8fdd7cd802a181241df5dfc9d8be70dad7793f4326767b"
    else
      url "https://github.com/timeplus-io/proton/releases/download/v#{version}/proton-v#{version}-Darwin-x86_64"
      sha256 "5842e1cff93503fe420f5414633fc9d7f5906439749c962273a24b82dc20ef9b"
    end
